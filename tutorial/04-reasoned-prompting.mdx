...
Here's a failure mode that trips up almost everyone when they first start using LLMs for anything beyond simple Q&A: you ask the model a question that requires logical reasoning, and it confidently gives you the wrong answer.
...
### OpenAI's Reasoning Models (o3, o4-mini)
...
# With o3/o4-mini: DON'T add "think step by step" — it's redundant
...
| Complex multi-step reasoning | o3 / o4-mini (OpenAI) or Extended Thinking (Claude) | Built-in reasoning is more reliable than prompted CoT |
...
You now know how to make models *think*. But thinking is only half the battle — you also need to make them *safe*. In the next module, we'll learn how to protect your prompts from injection attacks, isolate user data with delimiters, and build production-grade guardrails.
