...
*Non-technical readers: you can perform manual reviews instead of writing Python evaluation scripts for Stage 3.*
...
|:---|:---|:---|:---|
| **Run A** | GPT-4o-mini | GPT-4o | Claude Sonnet 4 |
| **Run B** | Gemini 2.5 Flash | Gemini 2.5 Pro | GPT-4o |
| **Run C** | Claude Haiku | Claude Sonnet 4 | Gemini 2.5 Pro |
